...
.. function:: broadcast(callback, socketId)
  ...
  :param callback: Void function for incoming data
  :type callback: |BroadcastMessageCallback|
  :param string socketId: Unique identifier assigned during server initialization
  :returns: Success when connection established
  :rtype: boolean
...
.. function:: remove(...targets)
  ...
  :returns: Number of extensions removed
  :rtype: number
...
.. function:: get(...targets)
  ...
  :returns: Installed extensions in current framework
  :rtype:
    - |Extension| or undefined
...
.. |resultElement| replace:: Target element(s) as *Node* instance
...
.. |WebSocketMessageChange| replace:: :ref:`WebSocketMessageChange <references-squared-base-file>`
