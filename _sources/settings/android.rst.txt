...
.. versionadded:: 5.7.0
  ...
  - *UserResourceSettingsUI* property **createBuildDependencies** enum value :target:`navigation` for navigation graphs was implemented.

.. versionadded:: 5.5.2

  - *UserResourceSettingsUI* property **supportUnicode** for UTF-16 and emoji detection was created.
  - *UserResourceSettingsUI* property **defaultIntlLocales** for :ref:`Intl.LocalesArgument <references-mdn-intl-locales_argument>` was created.
...
.. versionadded:: 5.3.0
  ...
  - **ExtensionComposeViewElement** extends the interface :target:`ViewAttribute`.
...
.. code-block::
  ...
  squared.settings = {
    ...
    defaultIntlLocales: null, // ["ja-JP", "ko-KR"]
    preloadImages: true,
    preloadFonts: true,
